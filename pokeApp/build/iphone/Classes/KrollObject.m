...
//@interface pokeAppObject : NSObject
//@end

@interface pokeAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[pokeAppObject class]])
		{
			for (NSString *key in [[(pokeAppObject*)o modules] allKeys])
			{
