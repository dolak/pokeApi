...
// in simulator we redefine to format for pokeApp Developer console
...
{\
	NSString * exceptionName = [@"org.pokeapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pokeapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIpokeAppNativeItemNone = -1, 
	UIpokeAppNativeItemSpinner = -2,
	UIpokeAppNativeItemProgressBar = -3,
	
	UIpokeAppNativeItemSlider = -4,
	UIpokeAppNativeItemSwitch = -5,
	UIpokeAppNativeItemMultiButton = -6,
	UIpokeAppNativeItemSegmented = -7,
	
	UIpokeAppNativeItemTextView = -8,
	UIpokeAppNativeItemTextField = -9,
	UIpokeAppNativeItemSearchBar = -10,
	
	UIpokeAppNativeItemPicker = -11,
	UIpokeAppNativeItemDatePicker = -12,
	
	UIpokeAppNativeItemInfoLight = -13,
	UIpokeAppNativeItemInfoDark = -14,
	
	UIpokeAppNativeItemDisclosure = -15,
	
	UIpokeAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all pokeApp instances of
