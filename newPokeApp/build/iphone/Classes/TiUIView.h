...
/**
 Base class for all newPokeApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the newPokeApp view hierarchy (such as wrapped iOS UIViews) was touched.
