...
// in simulator we redefine to format for newPokeApp Developer console
...
{\
	NSString * exceptionName = [@"org.newpokeapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.newpokeapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UInewPokeAppNativeItemNone = -1, 
	UInewPokeAppNativeItemSpinner = -2,
	UInewPokeAppNativeItemProgressBar = -3,
	
	UInewPokeAppNativeItemSlider = -4,
	UInewPokeAppNativeItemSwitch = -5,
	UInewPokeAppNativeItemMultiButton = -6,
	UInewPokeAppNativeItemSegmented = -7,
	
	UInewPokeAppNativeItemTextView = -8,
	UInewPokeAppNativeItemTextField = -9,
	UInewPokeAppNativeItemSearchBar = -10,
	
	UInewPokeAppNativeItemPicker = -11,
	UInewPokeAppNativeItemDatePicker = -12,
	
	UInewPokeAppNativeItemInfoLight = -13,
	UInewPokeAppNativeItemInfoDark = -14,
	
	UInewPokeAppNativeItemDisclosure = -15,
	
	UInewPokeAppNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all newPokeApp instances of
