...
//@interface newPokeAppObject : NSObject
//@end

@interface newPokeAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[newPokeAppObject class]])
		{
			for (NSString *key in [[(newPokeAppObject*)o modules] allKeys])
			{
