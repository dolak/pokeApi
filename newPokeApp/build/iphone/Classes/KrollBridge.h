...
@interface newPokeAppObject : KrollCoverageObject {
#else
@interface newPokeAppObject : KrollObject {
#endif
@private
...
extern NSString * newPokeApp$ModuleRequireFormat;
